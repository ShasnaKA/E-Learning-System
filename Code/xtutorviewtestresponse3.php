        ...
        <form action="" method=POST>
             ...
             <div class="form-group">
              ...
              <select name="txttopicfortest" id="topictodel" class="form-control" required>
                       <option value="none" selected>--Current or Previous Tests--</option>
                       <?php
...
<?php
 ...
 {
    echo '<script>location.href="xtutorviewtestresponsemissing.php?gname='.$gname.' & testid='.$topicfortest.'"</script>';
