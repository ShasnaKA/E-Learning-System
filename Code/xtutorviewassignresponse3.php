      ...
      <div class="deptform">
        ...
        <form action="" method=POST>
             ...
             <div class="form-group">
              <label>Select Assignment Topic to View</label>
              <select name="txttopicforassign" id="topictodel" class="form-control" required>
                       <option value="none" selected>--Previously Sheduled Works--</option>
                       <?php
              ...
              <div class="form-group">
              <br>
              <input type="submit" name="assigndelsubmit" class="btn btn-primary" value="View Submissions">&nbsp&nbsp 
...
<?php
 ...
 {
  $topicforassign=$_POST['txttopicforassign'];

  if($topicforassign=="none")
    echo '<script>alert(" Choose an Event To View Missing Attachments")</script>';

 else
 {
   echo '<script>location.href="xtutorviewassignresponsemissing.php?gname='.$gname.' & assignid='.$topicforassign.'"</script>';
