        ...
        <form action="" method=POST>
             ...
             <div class="form-group">
              ...
              <select name="txttopicforassign" id="topictodel" class="form-control" required>
                       <option value="none" selected>--Previously Scheduled Works--</option>
                       <?php
...
<?php
 ...
 {
   echo '<script>location.href="teachviewassignresponsemissing.php?gname='.$gname.' & assignid='.$topicforassign.'"</script>';
