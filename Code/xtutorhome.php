...
<body>
  ...
  <div class="myflexcontainer">
        ...
        <?php 
         ...
         $uid=$_SESSION['userid'];
         $sql="SELECT xgname,xtutorname from tblXGroup INNER JOIN tblXTutor ON tblXTutor.xtutoremail=tblXGroup.xtutorhostemail where xtutorhostemail='$uid' AND xgstatus=1";
         ...
         while($r=mysqli_fetch_array($result))
         {
          echo '<div class="item">';
          echo  '<h1>';
           echo '<a href="xtutorinsidegrp.php?gname='.$r['xgname'].'">'.$r['xgname'].'</a>';
          echo '</h1>';
