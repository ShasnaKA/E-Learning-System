...
<body>
              ...
              <label>Select Course</label>
                    <select name="txtcourseid" id="courseid" class="form-control" required>
                        ...
                        <?php
                          ...
                          $sql="SELECT cid,cname from tblCourse where instemail='$uid' AND coursestatus=1";
 ...
 <script>
      ...
      $.ajax({
      url: "getsemforinstviewresult.php?getcourseid=" +courseid,
      type:'POST',
...
<?php
 ...
 if(isset($_POST['grp_submit']))
 {
  ...
  {
    echo '<script>location.href="instviewstudresult.php?cid='.$courseid.'&sem='.$sem.'"</script>';
