    ...
    <div class="col-md-6">
      ...
      <div class="deptform">
        ...
        <form action="" method=POST enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    <label>Attach Material <label style="color:black">(pdf, txt, png, jpg, jpeg files only)</label></label>
...
<?php
 ...
 if(isset($_POST['mtrlsubmit']))
 {
  ...
  else
  {
    ...
    $check2="SELECT count(xmtrlgid) from tblXMaterial where xmtrlgid='$grpr2[0]' AND xmtrlname='$mtrltopic' AND xmtrlstatus=1 ";
   ...
   if($r2[0]>0)
   {
    ...
    echo '<script>location.href="xtutoraddmtrl.php?gname='.$gname.'"</script>';
   }
...
$sql2="INSERT INTO tblXMaterial(xmtrlgid,xmtrlname,xmtrldate,xattchmtrl,xmtrlpath,xmtrlstatus)VALUES('$grpr2[0]','$mtrltopic','$cdate','$file','$filepath' ,1)";
  if($conn->query($sql2)===TRUE)
    echo '<script>var choice=confirm("Material Shared Successfully.Do You want to add More?");
  if(choice==true){location.href="xtutoraddmtrl.php?gname='.$gname.'"}else{ location.href="xtutorinsidegrp.php?gname='.$gname.'"}</script>';
