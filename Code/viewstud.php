...
<body class="tablebody">
 ...
 <div>
  <table align="center">
    <tr class="main_title">
      <td colspan="7"><h2 style="text-align:center">Student Details</h2></td>
    </tr>
    <tr>
      <th>Name</th>
      ...
      <th>Action</th>
       ...
       while($row=mysqli_fetch_array($result))
        { 
            ...
            echo '<td><b><a href="instapprovestud.php?id='.$row['studemail'].' & status=-1 & place='.$place.'" class="red">Delete</a></td></b></tr>';
