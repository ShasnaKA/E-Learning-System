...
<body class="tablebody">
 ...
 <div>
  <table align="center">
    <tr class="main_title">
      <td colspan="6"><h2 style="text-align:center">Students Coursewise</h2></td>
    </tr>
    <tr>
      <th>Name</th>
      <th>Course</th>
      ...
      <th>Contact Number</th>
       ...
       $sql="SELECT studinstemail,studcid,studsem,studemail,studname,studreg,studcontact,tblCourse.cname FROM tblStudent INNER JOIN tblCourse ON tblCourse.cid=tblStudent.studcid where studinstemail='$r2[0]' AND studcid='$cid' AND studemail in (select uname from tblLogin where status=1)  ORDER BY studsem,studname";
