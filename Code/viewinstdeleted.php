...
<body class="tablebody">
 ...
 <div>
  <table align="center">
    <tr class="main_title">
      <td colspan="6"><h2 style="text-align:center">Institutions Deleted</h2></td>
    </tr>
    <tr>
      <th>Institution</th>
      <th>E-mail</th>
      ...
      <th>Action</th>
       ...
       while($row=mysqli_fetch_array($result))
        { 
            ...
            echo '<td><b><a href="adminapproveinst.php?id='.$row['instemail'].'& status=1 & place='.$place.'" class="red">Reapprove</a></b></td>';
