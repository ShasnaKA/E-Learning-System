...
<body class="tablebody">
 ...
 <div>
  <table align="center">
    <tr class="main_title">
      <td colspan="6"><h2 style="text-align:center">Tutors Deleted</h2></td>
    </tr>
    <tr>
      <th>Name</th>
      <th>E-mail</th>
    ...
    <?php
       ...
       while($row=mysqli_fetch_array($result))
        { 
            ...
            echo '<td><b><a href="adminapproveinst.php?id='.$row['xtutoremail'].' & status=1 & place='.$place.'" class="red">Reapprove</a></td></b></tr>';
