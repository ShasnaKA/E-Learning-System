<?php
 include 'HODhome1.php';// insidegrpcommon.php already has session_start()
        ...
        <form action="" method="POST">
                   ...
                   <div class="form-group">
                    ...
                    $uid=$_SESSION['userid'];
                     ...
                     $sql="SELECT HODname,HODemail,HODqualf,tblDepartment.depname,tblInstitution.instname,tblInstitution.instaddress,HODcontact from tblHOD INNER JOIN tblDepartment ON tblDepartment.depid=tblHOD.HODdepid INNER JOIN tblInstitution ON tblInstitution.instemail=tblHOD.HODinstemail where HODemail='$uid' AND HODemail in (select uname from tblLogin where status=1)";
                     $result=$conn->query($sql);
                     $row=mysqli_fetch_array($result);
                    echo '<input type="text"  class="namecls" name="txtHODname" value="'.$row['HODname'].'" required>';
                    ?>
                  </div>
              ...
              <div class="row">
               <div class="col-md-6">
                  ...
                  <div class="form-group">
                    ...
                    <select name="txtHODqualf" class="clsdatebox" required="">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <?php
                    echo '<input type="text" class="clsdatebox" value="'.$row['HODemail'].'" readonly>';
                    ?>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <?php
                    echo '<input type="number" class="clsdatebox" name="txtHODcontact" value="'.$row['HODcontact'].'" required>';
                    ?>
                  </div>
                </div>
...
<?php
 ...
 if(isset($_POST['profile_editsubmit']))
 {
    ...
    {
    $q="UPDATE tblHOD set HODname='$HODname',HODcontact='$HODcontact',HODqualf='$HODqualf' where HODemail='$uid'";
