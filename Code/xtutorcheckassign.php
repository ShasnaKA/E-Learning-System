            ...
            <input type="text" name="txtstud" class="form-control" value="<?php echo $row['xstudname'] ?>" readonly>
                 ...
                 <div class="row">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="txttest"  value="<?php echo $row['xassignname'] ?>" readonly>
                  </div>

                  <div class="form-group">
                    <label>Max Marks</label>
                    <input type="text" name="txtmax"  value="<?php echo $row['xassignmax'] ?>" readonly>
                  </div>
                </div>
                  ...
                  <div class="col-md-6">
                   <div class="form-group">
                    ...
                    <input type="text" name="txttest" value="<?php echo $assign_answr ?>" readonly>
                  </div>
