  	  ...
  	  <div class="row">
  	  	<div class="col-md-6 " id="form">
  	  		...
  	  		<form method="POST" action="">
  	  			...
  	  			<div class="form-group">
  	  			    <label>E-mail</label>
  	  			  <input type="email" name="txtstudemail" class="form-control" placeholder="example@gmail.com" required="">
  	  			</div>
            ...
            <input type="text" name="txtstudreg" class="form-control" placeholder="Your Current Register Number" required="">
            </div>

            <div class="form-group">
              <label>Course</label>
              <select name="txtstudcid" id="txtstudcid" class="form-control" required>
                <option value="none" selected>--Select Your Current Course--</option>
              ...
              <select name="txtstudsem" class="form-control" required>
                ...
                <option value="Semester 6">Semester 6</option>
  	  			...
  	  			<input type="text" name="txtstudcontact" class="form-control" placeholder="Your Contact" pattern="[6789][0-9]{9}" required="">
  	  			</div>
  	  			<div class="form-group">
...
if(isset($_POST['studreg']))
{
  ...
  $studsem=$_POST['txtstudsem'];
	...
	$sql="INSERT  INTO tblStudent (studemail,studinstemail,studname,studreg,studcid,studsem,studcontact) VALUES ('$studemail','$studinstemail','$studname','$studreg','$studcid','$studsem','$studcontact')";
