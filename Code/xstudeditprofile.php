      ...
      <div class="deptform">
        ...
        <form action="" method="POST">
                   ...
                   <div class="form-group">
                    <label>Name <em style="color:black">(Editable)</em></label><br>
                    <?php
                    $uid=$_SESSION['userid'];
                    ...
                    echo '<input type="text"  class="clsdatebox" name="txtstudname" value="'.$row['xstudname'].'" required>';
                    ?>
                  </div>
                  ...
                  <div class="form-group">
                    <label class="clstestlabel">Age <em style="color:black">(Editable)</em></label><br>
                    <?php
                    echo '<input type="number" class="clsdatebox" name="txtstudage" value="'.$row['xstudage'].'" required>';
                    ?>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <?php
                    echo '<input type="number" class="clsdatebox" name="txtstudcontact" value="'.$row['xstudcontact'].'" required>';
                    ?>
                  </div>
...
<?php
 ...
 if(isset($_POST['profile_editsubmit']))
 {
    ...
    $studage=$_POST['txtstudage'];

    $q="UPDATE tblXStudent set xstudname='$studname',xstudcontact='$studcontact',xstudage='$studage' where xstudemail='$uid'";
