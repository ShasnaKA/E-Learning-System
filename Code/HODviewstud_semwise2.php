 ...
 <div>
  <table align="center">
    ...
    <tr>
      ...
      $sql="SELECT studinstemail,studcid,studsem,studemail,studname,studreg,studcontact,tblCourse.cname,tblCourse.depid FROM tblStudent INNER JOIN tblCourse ON tblCourse.cid=tblStudent.studcid where studinstemail='$r2[0]' AND studcid='$cid' AND studsem='$sem' AND studemail in (select uname from tblLogin where status=1)  ORDER BY studname";
