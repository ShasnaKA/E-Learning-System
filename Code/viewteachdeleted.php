...
<body class="tablebody">
 ...
 <div>
  <table align="center">
    <tr class="main_title">
      <td colspan="6"><h2 style="text-align:center">Teacher Deleted</h2></td>
    </tr>
    <tr>
      <th>Name</th>
      <th>E-mail</th>
      ...
      <th>Action</th>
       ...
       while($row=mysqli_fetch_array($result))
        { 
            ...
            echo '<td><b><a href="instapproveteach.php?id='.$row['teachemail'].' & status=1 & place='.$place.'" class="red">Reapprove</a></b></td></tr>';
